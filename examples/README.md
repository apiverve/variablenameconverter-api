# Variable Name Converter API - Examples

This folder contains example code for using the Variable Name Converter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/variablenameconverter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/variablenameconverter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/variablenameconverter](https://docs.apiverve.com/ref/variablenameconverter)
