# Variable Name Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:variablenameconverter-api:1.1.12'
}
```
...
```java
import com.apiverve.variablenameconverter.VariableNameConverterAPIClient;
import com.apiverve.variablenameconverter.APIResponse;
import com.apiverve.variablenameconverter.APIException;

// Initialize the client
VariableNameConverterAPIClient client = new VariableNameConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/variablenameconverter](https://docs.apiverve.com/ref/variablenameconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/variablenameconverter](https://docs.apiverve.com/ref/variablenameconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/variablenameconverter-api/issues)
