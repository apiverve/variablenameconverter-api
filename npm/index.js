...
class variablenameconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/variablenameconverter');
        }
        ...
        this.validationRules = {"variables":{"type":"array","required":true},"to":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/variablenameconverter`);
        }
    }
...
module.exports = variablenameconverterWrapper;
