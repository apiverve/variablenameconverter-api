...
namespace APIVerve.API.VariableNameConverter
{
    ...
    /// <summary>
    /// Client for the VariableNameConverter API
    /// </summary>
    public class VariableNameConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/variablenameconverter";
        ...
        {
            { "variables", new ValidationRule { Type = "array", Required = true } },
        ...
        public VariableNameConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VariableNameConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VariableNameConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, VariableNameConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(VariableNameConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(VariableNameConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(VariableNameConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(VariableNameConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(VariableNameConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(VariableNameConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(VariableNameConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(VariableNameConverterQueryOptions options)
        {
