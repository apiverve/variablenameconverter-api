...
class TestVariablenameconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = VariablenameconverterAPIClient(self.api_key)

    @patch('apiverve_variablenameconverter.apiClient.requests.get')
