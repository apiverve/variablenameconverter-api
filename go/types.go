...
// Request contains the parameters for the Variable Name Converter API.
//
// Parameters:
...
// ResponseData contains the data returned by the Variable Name Converter API.
...
// ResultsItem represents an item in the Results array.
